...
namespace margelo::nitro::jetvideo {
  ...
  class HybridVideoViewSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::string getPosterUri() = 0;
      virtual void setPosterUri(const std::string& posterUri) = 0;
      virtual std::string getPlayerKey() = 0;
      virtual void setPlayerKey(const std::string& playerKey) = 0;
      ...
      virtual std::string getCoordinatorGroup() = 0;
      virtual void setCoordinatorGroup(const std::string& coordinatorGroup) = 0;
      ...
      virtual std::function<void(const LoadEvent& /* event */)> getOnLoad() = 0;
      virtual void setOnLoad(const std::function<void(const LoadEvent& /* event */)>& onLoad) = 0;
      virtual std::function<void(const ProgressEvent& /* event */)> getOnProgress() = 0;
      virtual void setOnProgress(const std::function<void(const ProgressEvent& /* event */)>& onProgress) = 0;
      virtual std::function<void()> getOnEnd() = 0;
      virtual void setOnEnd(const std::function<void()>& onEnd) = 0;
      virtual std::function<void(const VideoErrorEvent& /* event */)> getOnError() = 0;
      virtual void setOnError(const std::function<void(const VideoErrorEvent& /* event */)>& onError) = 0;
      virtual std::function<void(const PlaybackStateEvent& /* event */)> getOnPlaybackStateChange() = 0;
      virtual void setOnPlaybackStateChange(const std::function<void(const PlaybackStateEvent& /* event */)>& onPlaybackStateChange) = 0;
      virtual std::function<void(bool /* isFullscreen */)> getOnFullscreenChange() = 0;
      virtual void setOnFullscreenChange(const std::function<void(bool /* isFullscreen */)>& onFullscreenChange) = 0;
      virtual std::function<void(bool /* isActive */)> getOnPictureInPictureChange() = 0;
      virtual void setOnPictureInPictureChange(const std::function<void(bool /* isActive */)>& onPictureInPictureChange) = 0;
      virtual std::function<void(bool /* muted */)> getOnMutedChange() = 0;
      virtual void setOnMutedChange(const std::function<void(bool /* muted */)>& onMutedChange) = 0;
      virtual std::function<void(double /* visibleFraction */)> getOnVisibilityChange() = 0;
      virtual void setOnVisibilityChange(const std::function<void(double /* visibleFraction */)>& onVisibilityChange) = 0;
