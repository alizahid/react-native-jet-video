...
/**
 * Wraps a Swift `(_ visibleFraction: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.jetvideo.bridge.swift

  private let closure: (_ visibleFraction: Double) -> Void

  public init(_ closure: @escaping (_ visibleFraction: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(visibleFraction: Double) -> Void {
    self.closure(visibleFraction)
  }
