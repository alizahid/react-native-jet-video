...
/**
 * Wraps a Swift `(_ isFullscreen: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.jetvideo.bridge.swift

  private let closure: (_ isFullscreen: Bool) -> Void

  public init(_ closure: @escaping (_ isFullscreen: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isFullscreen: Bool) -> Void {
    self.closure(isFullscreen)
  }
